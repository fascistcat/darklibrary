...
# Default definitions.
$def_authentication = isset($def_authentication) ? $def_authentication : true; // Defines if this file should make a session authentication.
$def_printHTML = isset($def_printHTML) ? $def_printHTML : true; // Defines if this file should print the basic view for the page.
$def_navBar = isset($def_navBar) ? $def_navBar : true; // Defines if the navbar should be shown.
$def_currentTab = isset($def_currentTab) ? $def_currentTab : null; // Gives the $def_currentTab a default value.
